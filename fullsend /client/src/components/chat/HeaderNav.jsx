...
const useStyles = makeStyles(theme => ({
  ...
  subActiveJackpot: {
    ...
    "& > button": {
      ...
      letterSpacing: ".05em",
      color: "#e0e0e0",
      borderLeft: "2px solid hsl(230, 50%, 50%)",
      borderRadius: "0px",
      marginRight: 20,
      "& img": {
        opacity: 0.15,
...
const HeaderNav = ({ isAuthenticated, isLoading, user, logout, handleClose }) => {
  ...
  return (
    <Toolbar variant="dense" className={classes.root2}>
      <LoginModal open={openBlox} user={user}  />
