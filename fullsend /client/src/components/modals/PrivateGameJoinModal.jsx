...
const AdditionalVerification = ({ open, handleClose, onChange, loading }) => {
  ...
  return (
    ...
    >
      <DialogTitle className={classes.titlePoppins} onClose={handleClose} style={{ fontFamily: "Poppins", }}>
        <span style={{ fontFamily: "Poppins", }}><span style={{ fontWeight: "300", marginRight: "10px", color: "#4caf50", }}><VerifiedUserIcon style={{ marginBottom: "-3.4px", }} /></span>Join Game</span>
      </DialogTitle>
      {loading ? (
        <DialogContent>
