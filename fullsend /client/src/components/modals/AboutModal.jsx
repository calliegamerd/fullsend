  ...
  return (
    ...
    >
      ...
      <div className={classes.content} >
        <p> Fullsend.gg is an innovative Social Arcade tailored to the real items case opening experience. </p>
        <p> It's our mission for consumer satisfaction, and we are tired of the bullshit of the current industry. </p>
        <p> On Fullsend.gg you will find provably fair gamemodes, seamless crypto withdraws, rewards for all levels of player, and an amazing GUI. </p>
        ...
        <p> Join our mission, Join Fullsend.gg </p>
      </div> 
    </Dialog>
  );
};
