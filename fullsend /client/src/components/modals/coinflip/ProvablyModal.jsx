...
const Provably = ({ open, handleClose, game }) => {
  ...
  return (
    <Dialog
      ...
      open={open}
    >
      <DialogTitle onClose={handleClose} className={classes.titlePoppins}>
        <span style={{ fontFamily: "Poppins", color: "#e0e0e0", }}><span style={{ fontWeight: "300", }}></span> Provably Fair</span>
      </DialogTitle>
      <DialogContent >
        <Field
