  ...
  return (
      ...
      >    
        ...
        <div className={classes.content} >
          <div style={{display: "flex", gap: "0.5rem", color: "#fff"}}><span style={{color: "#838b8d"}}>Open a support ticket in our</span><a style={{color: "#fff"}} href="https://discord.gg/j82fApKDRb">Discord</a></div>
