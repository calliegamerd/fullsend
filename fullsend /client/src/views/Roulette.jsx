...
const useStyles = makeStyles(theme => ({
  ...
  cardGreen: {
    ...
    boxShadow: "0 10px 27px #1eb8fa, inset 0 2px #1286b8, inset 0 -2px #1f83ad",
  },
  game: {
    display: "flex",
    width: "56%",
              ...
              <div className={classes.wheelR} 
                ...
                {[...Array(15)].map((row, i) => (
                  <div key={i} className={classes.rowR}>
                    ...
                    <div className={classes.cardGreen} style={{ zIndex: wheelTransformNumber0zIndex, transition: "all 400ms", transform: `${wheelTransformNumber0}`, WebkitTransform: `${wheelTransformNumber0}`, }}></div>
