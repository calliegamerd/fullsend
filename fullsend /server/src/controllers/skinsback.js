...
const withdraw_itemsCSGO = async (user_id, items, tradelink) => {
    try {
        ...
        // Check that user has wagered at least 100% of his deposited amount    
        if (dbUser.wagerNeededForWithdraw > 0)
            return {
                success: false,
                error: `You must wager at least $${dbUser.wagerNeededForWithdraw.toFixed(2)} before withdrawing!`,
            };
